...
const PickBuilderShellSkeleton = () => {
    ...
    return (
        <div className="space-y-6 animate-pulse pt-4">
            <div className="-mx-5 px-5 sm:-mx-6 sm:px-6">
                {/* Date Tabs Skeleton */}
                <div className="scrollbar-hide -mx-5 mt-4 flex gap-3 overflow-x-auto px-5 pb-2 sm:mx-0 sm:px-0">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div key={i} className="h-4 w-15 shrink-0 rounded bg-white/10" />
                    ))}
                </div>

                {/* League selection Tabs Skeleton */}
                <div className="scrollbar-hide -mx-5 mt-4 flex gap-3 overflow-x-auto border-b border-white/10 px-5 pb-2 sm:mx-0 sm:px-0">
                    {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="h-6 w-18 shrink-0 rounded bg-white/5" />
                    ))}
                </div>
            </div>
...
export default PickBuilderShellSkeleton;

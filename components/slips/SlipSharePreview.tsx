...
import SlipShareSkeleton from "../skeletons/slips/SlipShareSkeleton";

type SlipSharePreviewProps = {
    open: boolean;
    onClose: () => void;
    slip?: Slip | null;
    picks?: Pick[];
...
const SlipSharePreview = ({
    ...
    const groupComboOddsSummary = useMemo(
        () => (slip ? getLeagueComboOddsSummary(slip, picks) : null),
        [slip, picks]
    );
            ...
            >
                ...
                >
                    ...
                    <div className="mt-5 flex justify-end gap-3">
                        <div className="h-9 w-44 animate-pulse rounded-2xl bg-white/10" />
                        <button
                            type="button"
                            onClick={onClose}
...
export default SlipSharePreview;

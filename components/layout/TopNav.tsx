      ...
      {menuOpen && (
        <div className="fixed inset-0 z-40 flex">
          <button
            ...
            className="h-full w-full bg-black/50 backdrop-blur-sm transition-opacity"
          />
          <div className="absolute left-0 top-0 h-full w-[80vw] min-w-[260px] bg-gradient-to-b from-white/8 via-white/5 to-black/80 p-6 shadow-2xl shadow-emerald-500/20 ring-1 ring-white/10 sm:w-[40vw] lg:w-[25vw]">

        ...
        >
            ...
            >
                ...
                <div className="px-6 pt-4 shrink-0">
                    <p className="mb-1 text-[10px] uppercase tracking-[0.2em] text-emerald-300">
                        {current.label}
                    </p>
                ...
                <div className="flex items-center justify-between px-6 pb-6 pt-4 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="rounded-xl border border-emerald-400/60 bg-emerald-500/20 px-5 py-2 text-xs font-semibold text-emerald-100 hover:border-emerald-300/80 hover:text-white"
                        >

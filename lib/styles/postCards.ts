...
export const PENDING_POST_CARD_TONE =
    "border border-white/10 border-b-[3px] border-b-white/20 bg-white/[0.04] shadow-[inset_0_1px_0_rgba(255,255,255,0.06),inset_0_-2px_0_rgba(255,255,255,0.08),inset_0_0_0_1px_rgba(255,255,255,0.04),0_2px_10px_rgba(0,0,0,0.18)]";
